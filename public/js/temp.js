...
dataLayer.push({
  ...
  'action' : 'Auto',
  'nonInteraction' : true,
  'virtualPageURL':'/competition/(slug)/player/(version)/video/(kind)/player',
  'virtualPageTitle' : 'Player'
});
...
dataLayer.push({
  ...
  'virtualPageTitle' : 'Chapter - (ID o Name)'
});
dataLayer.push({
  'event':'interaction',
  'label':'Close',
...
dataLayer.push({
  'event':'VirtualPageview',
  'virtualPageURL':'/competition/(slug)/player/(version)/video/(kind)/layout/(fullscreen)',
  'virtualPageTitle' : 'Layout - Fullscreen'
});
dataLayer.push({
  'event':'VirtualPageview',
  'virtualPageURL':'/competition/(slug)/player/(version)/video/(kind)/layout/(maincam)',
  'virtualPageTitle' : 'Layout - MainCam - (ID)'
});
dataLayer.push({
  'event':'VirtualPageview',
  'virtualPageURL':'/competition/(slug)/player/(version)/video/(kind)/marker/(type)',
...
dataLayer.push({
  'event':'VirtualPageview',
  'virtualPageURL':'/competition/(slug)/player/(version)/video/(kind)/milestone/(type)',
  'virtualPageTitle' : 'Milestone - (type)'
});
dataLayer.push({
  'event':'VirtualPageview',
  'virtualPageURL':'/competition/(slug)/player/(version)/video/(kind)/overlay/(id)/html',
...
dataLayer.push({
  'event':'VirtualPageview',
  'virtualPageURL':'/competition/(slug)/player/(version)/video/(kind)/layout/(multicam)',
  'virtualPageTitle' : 'Layout - Multicam - (ID)'
});
dataLayer.push({
  'event':'VirtualPageview',
  'virtualPageURL':'/competition/(slug)/player/(version)/video/(kind)/layout/(pip)',
  'virtualPageTitle' : 'Layout - PiP - (ID)'
});
dataLayer.push({
  'event':'VirtualPageview',
  'virtualPageURL':'/competition/(slug)/player/(version)/video/(kind)/layout/(quadcam)',
  'virtualPageTitle' : 'Layout - QuadCam - (ID)'
});
dataLayer.push({
  'event':'VirtualPageview',
  'virtualPageURL':'/competition/(slug)/player/(version)/video/(kind)/layout/(multistream)',
  'virtualPageTitle' : 'Layout - Multistream - (ID)'
});
dataLayer.push({
  'event':'VirtualPageview',
  'virtualPageURL':'/competition/(slug)/player/(version)/video/(kind)/suggested/(type)',
